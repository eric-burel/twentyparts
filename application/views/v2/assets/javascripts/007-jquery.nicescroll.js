(function (e) {
    ...
    c.forEach(function (e) {
        if (!h)
            h = window[e + "RequestAnimationFrame"];
        if (!p)
            p = window[e + "CancelAnimationFrame"] || window[e + "CancelRequestAnimationFrame"]
    });
    var d = window.MutationObserver || window.WebKitMutationObserver || false;
    var v = {zindex: "auto", cursoropacitymin: 0, cursoropacitymax: 1, cursorcolor: "#424242", cursorwidth: "5px", cursorborder: "1px solid #fff", cursorborderradius: "5px", scrollspeed: 60, mousescrollstep: 8 * 3, touchbehavior: false, hwacceleration: true, usetransition: true, boxzoom: false, dblclickzoom: true, gesturezoom: true, grabcursorenabled: true, autohidemode: true, background: "", iframeautoresize: true, cursorminheight: 32, preservenativescrolling: true, railoffset: false, bouncescroll: true, spacebarenabled: true, railpadding: {top: 0, right: 0, left: 0, bottom: 0}, disableoutline: true, horizrailenabled: true, railalign: "right", railvalign: "bottom", enabletranslate3d: true, enablemousewheel: true, enablekeyboard: true, smoothscroll: true, sensitiverail: true, enablemouselockapi: true, cursorfixedheight: false, directionlockdeadzone: 6, hidecursordelay: 400, nativeparentscrolling: true, enablescrollonselection: true, overflowx: true, overflowy: true, cursordragspeed: .3, rtlmode: false, cursordragontouch: false};
    var m = false;
    var g = function () {
        function o() {
    ...
    var y = function (e, r) {
        ...
        function E(e, t, n, r) {
            a._bind(e, t, function (r) {
                ...
                var i = {original: r, target: r.target || r.srcElement, type: "wheel", deltaMode: r.type == "MozMousePixelScroll" ? 0 : 1, deltaX: 0, deltaZ: 0, preventDefault: function () {
        ...
        this.lastdeltay = 0;
        this.detected = g();
        var l = u.extend({}, this.detected);
        this.canhwscroll = l.hastransform && a.opt.hwacceleration;
        this.ishwscroll = this.canhwscroll && a.haswrapper;
        this.istouchcapable = false;
        if (l.cantouch && l.ischrome && !l.isios && !l.isandroid) {
            this.istouchcapable = true;
            l.cantouch = false
        }
        if (l.cantouch && l.ismozilla && !l.isios) {
            this.istouchcapable = true;
            l.cantouch = false
        }
        if (!a.opt.enablemouselockapi) {
            l.hasmousecapture = false;
            l.haspointerlock = false
        }
        this.delayed = function (e, t, n, r) {
            ...
            if (i && i.last + n > s && !i.tt) {
                a.delaylist[e] = {last: s + n, tt: setTimeout(function () {
                        a.delaylist[e].tt = 0;
                        t.call()
                    }, n)}
            } else if (!i || !i.tt) {
        ...
        if (this.ishwscroll) {
            ...
            if (l.hastranslate3d && l.isios)
                this.doc.css("-webkit-backface-visibility", "hidden");
            function c() {
                var e = a.doc.css(l.trstyle);
            ...
            if (l.hastranslate3d && a.opt.enabletranslate3d) {
                this.setScrollTop = function (e, t) {
                    a.doc.translate.y = e;
                    a.doc.translate.ty = e * -1 + "px";
                    a.doc.css(l.trstyle, "translate3d(" + a.doc.translate.tx + "," + a.doc.translate.ty + ",0px)");
                    if (!t)
                ...
                this.setScrollTop = function (e, t) {
                    a.doc.translate.y = e;
                    a.doc.translate.ty = e * -1 + "px";
                    a.doc.css(l.trstyle, "translate(" + a.doc.translate.tx + "," + a.doc.translate.ty + ")");
                    if (!t)
                        a.notifyScrollEvent(a.win[0])
                };
                this.setScrollLeft = function (e, t) {
        ...
        this.updateScrollBar = function (e) {
            if (a.ishwscroll) {
                ...
                if (a.railh)
                    a.railh.css({width: a.win.innerWidth()})
            } else {
                var t = a.getOffset();
                ...
                if (!a.locked)
                    a.rail.css({top: n.top, left: n.left, height: e ? e.h : a.win.innerHeight()});
                if (a.zoom) {
                    a.zoom.css({top: n.top + 1, left: a.rail.align == 1 ? n.left - 20 : n.left + a.rail.width + 4})
                }
                if (a.railh && !a.locked) {
                    var n = {top: t.top, left: t.left};
        ...
        this.init = function () {
            ...
            if (!a.ispage || !l.cantouch && !l.isieold && !l.isie9mobile) {
                var e = a.docscroll;
                if (a.ispage)
                    e = a.haswrapper ? a.win : a.doc;
                if (!l.isie9mobile)
                    a.css(e, {"overflow-y": "hidden"});
                if (a.ispage && l.isie7) {
                ...
                if (l.isios && !a.ispage && !a.haswrapper)
                ...
                var f, c, h = ["left", "right"];
                for (var p in h) {
                    c = h[p];
                    f = a.opt.railpadding[c];
                    f ? s.css("padding-" + c, f + "px") : a.opt.railpadding[c] = 0
                }
                s.append(r);
                ...
                a.rail.drag = false;
                var v = false;
                if (a.opt.boxzoom && !a.ispage && !l.isieold) {
                    v = document.createElement("div");
                    a.bind(v, "click", a.doZoom);
                    a.zoom = u(v);
                    a.zoom.css({cursor: "pointer", "z-index": a.zindex, backgroundImage: "url(" + urls["img"] + "zoomico.png)", height: 18, width: 18, backgroundPosition: "0px 0px"});
                    if (a.opt.dblclickzoom)
                        a.bind(a.win, "dblclick", a.doZoom);
                    if (l.cantouch && a.opt.gesturezoom) {
                ...
                if (a.opt.horizrailenabled) {
                    ...
                    a.cursorh = r;
                    var g = u(document.createElement("div"));
                    g.attr("id", a.id + "-hr");
                    g.addClass("nicescroll-rails");
                    g.height = Math.max(parseFloat(a.opt.cursorwidth), r.outerHeight());
                    g.css({height: g.height + "px", zIndex: a.zindex, background: a.opt.background});
                    g.append(r);
                    g.visibility = true;
                    g.scrollable = true;
                    g.align = a.opt.railvalign == "top" ? 0 : 1;
                    a.railh = g;
                    a.railh.drag = false
                }
                if (a.ispage) {
                    ...
                    a.body.append(s);
                    if (a.railh) {
                        g.css({position: "fixed", left: "0px", width: "100%"});
                        g.align ? g.css({bottom: "0px"}) : g.css({top: "0px"});
                        a.body.append(g)
                    }
                } else {
                    if (a.ishwscroll) {
                        ...
                        var y = a.win[0].nodeName == "HTML" ? a.body : a.win;
                        if (a.zoom) {
                        ...
                        if (g) {
                            ...
                            g.align ? g.css({bottom: 0}) : g.css({top: 0});
                            y.append(g)
                        }
                    } else {
                    ...
                    if (l.isie && a.opt.disableoutline)
                        a.win.attr("hideFocus", "true");
                    if (l.iswebkit && a.opt.disableoutline)
                ...
                if (l.isie9mobile) {
                    ...
                    a.mangotouch = {sy: E, ly: E, dry: 0, sx: S, lx: S, drx: 0, lazy: false, tm: 0};
                    a.bind(a.docscroll, "scroll", a.onmangotouch)
                } else {
                    if (l.cantouch || a.istouchcapable || a.opt.touchbehavior || l.hasmstouch) {
                        a.scrollmom = new b(a);
                        a.ontouchstart = function (e) {
                            ...
                            if (!a.locked) {
                                ...
                                a.rail.drag = {x: e.clientX, y: e.clientY, sx: a.scroll.x, sy: a.scroll.y, st: a.getScrollTop(), sl: a.getScrollLeft(), pt: 2, dl: false};
                                if (a.ispage || !a.opt.directionlockdeadzone) {
                                    a.rail.drag.dl = "f"
                                } else {
                                    var s = {w: u(window).width(), h: u(window).height()};
                                    var o = {w: Math.max(document.body.scrollWidth, document.documentElement.scrollWidth), h: Math.max(document.body.scrollHeight, document.documentElement.scrollHeight)};
                                    ...
                                    if (!a.rail.scrollable && a.railh.scrollable)
                                        ...
                                        a.rail.drag.ck = c > 0 ? "h" : false;
                                    else
                                        a.rail.drag.ck = false;
                                    if (!a.rail.drag.ck)
                                        a.rail.drag.dl = "f"
                                }
                                if (a.opt.touchbehavior && a.isiframe && l.isie) {
                                ...
                                if (!l.cantouch && !this.istouchcapable && !l.hasmstouch) {
                                    var p = t ? /INPUT|SELECT|TEXTAREA/i.test(t.nodeName) : false;
                                    if (!p) {
                                        if (!a.ispage && l.hasmousecapture)
                                            t.setCapture();
                                        return a.cancelEvent(e)
                                    }
                        ...
                        var x = a.opt.touchbehavior && a.isiframe && !l.hasmousecapture;
                        a.ontouchmove = function (e, t) {
                            if (e.pointerType && e.pointerType != 2)
                                return false;
                            if (a.rail.drag && a.rail.drag.pt == 2) {
                                if (l.cantouch && typeof e.original == "undefined")
                                    return true;
                                a.hasmoving = true;
                                ...
                                if (l.ischrome && a.istouchcapable)
                                    v = false;
                                if (v)
                                    return a.cancelEvent(e)
                            }
                    ...
                    a.onmousedown = function (e, t) {
                        ...
                        if (!a.ispage && l.hasmousecapture)
                            n.setCapture();
                        if (a.isiframe && !l.hasmousecapture) {
                    ...
                    if (l.cantouch || a.opt.touchbehavior) {
                        ...
                        a.onclick = l.isios ? false : function (e) {
                            if (a.lastmouseup) {
                                a.lastmouseup = false;
                                return a.cancelEvent(e)
                            } else {
                        ...
                        if (a.opt.grabcursorenabled && l.cursorgrabvalue) {
                            a.css(a.ispage ? a.doc : a.win, {cursor: l.cursorgrabvalue});
                            a.css(a.rail, {cursor: l.cursorgrabvalue})
                        }
                    } else {
                        function T(e) {
                            if (!a.selectiondrag)
                    ...
                    if (a.opt.cursordragontouch || !l.cantouch && !a.opt.touchbehavior) {
                    ...
                    if (!l.cantouch && !a.opt.touchbehavior) {
                        a.bind(l.hasmousecapture ? a.win : document, "mouseup", a.onmouseup);
                        ...
                        a.bind(l.hasmousecapture ? a.win : document, "mouseup", a.ontouchend);
                    ...
                    if (a.opt.enablemousewheel) {
                        if (!a.isiframe)
                            a.bind(l.isie && a.ispage ? document : a.docscroll, "mousewheel", a.onmousewheel);
                        a.bind(a.rail, "mousewheel", a.onmousewheel);
                        if (a.railh)
                            a.bind(a.railh, "mousewheel", a.onmousewheelhr)
                    }
                    if (!a.ispage && !l.cantouch && !/HTML|BODY/.test(a.win[0].nodeName)) {
                        if (!a.win.attr("tabindex"))
                            a.win.attr({tabindex: i++});
                ...
                if (a.opt.enablekeyboard)
                    a.bind(document, l.isopera && !l.isopera12 ? "keypress" : "keydown", a.onkeypress);
                a.bind(window, "resize", a.lazyResize);
                a.bind(window, "orientationchange", a.lazyResize);
                a.bind(window, "load", a.lazyResize);
                if (l.ischrome && !a.ispage && !a.haswrapper) {
                ...
                if (!a.ispage && !a.haswrapper) {
                    if (d !== false) {
                        ...
                        a.observerremover.observe(a.win[0].parentNode, {childList: true, characterData: false, attributes: false, subtree: false})
                    } else {
                        a.bind(a.win, l.isie && !l.isie9 ? "propertychange" : "DOMAttrModified", a.onAttributeChange);
                        if (l.isie9)
            ...
            if (this.doc[0].nodeName == "IFRAME") {
                function k(e) {
                    ...
                    a.forcescreen = true;
                    if (a.isiframe) {
                        a.iframe = {doc: u(t), html: a.doc.contents().find("html")[0], body: a.doc.contents().find("body")[0]};
                    ...
                    if (!l.isios && a.opt.iframeautoresize && !a.isiframe) {
                        a.win.scrollTop(0);
                        a.doc.height("");
                    ...
                    a.lazyResize(30);
                    if (l.isie7)
                        a.css(u(a.iframe.html), {"overflow-y": "hidden"});
                    ...
                    if (a.opt.enablekeyboard)
                        a.bind(t, l.isopera ? "keypress" : "keydown", a.onkeypress);
                    if (l.cantouch || a.opt.touchbehavior) {
                        a.bind(t, "mousedown", a.onmousedown);
                        a.bind(t, "mousemove", function (e) {
                            a.onmousemove(e, true)
                        });
                        if (a.opt.grabcursorenabled && l.cursorgrabvalue)
                            a.css(u(t.body), {cursor: l.cursorgrabvalue})
                    }
                    a.bind(t, "mouseup", a.onmouseup);
                    if (a.zoom) {
                        if (a.opt.dblclickzoom)
        ...
        this.showCursor = function (e, t) {
            ...
            if (a.cursorh) {
                !a.rail.align && a.rail.visibility ? a.cursorh.css({width: a.cursorwidth, left: a.scroll.x + a.rail.width}) : a.cursorh.css({width: a.cursorwidth, left: a.scroll.x});
                a.cursoractive = true
            }
            if (a.zoom)
        ...
        this.bind = function (e, t, n, r) {
            ...
            if (t == "mousewheel") {
                if ("onwheel"in a.win) {
                    ...
                    E(i, s, n, r || false);
                    if (s == "DOMMouseScroll")
                        E(i, "MozMousePixelScroll", n, r || false)
                }
            } else if (i.addEventListener) {
                if (l.cantouch && /mouseup|mousedown|mousemove/.test(t)) {
        ...
        if (!a.opt.smoothscroll) {
        ...
        } else if (a.ishwscroll && l.hastransition && a.opt.usetransition) {
            this.prepareTransition = function (e, t) {
                var n = t ? e > 20 ? e : 0 : a.getTransitionSpeed(e);
                var r = n ? l.prefixstyle + "transform " + n + "ms ease-out" : "";
                if (!a.lasttransitionstyle || a.lasttransitionstyle != r) {
                    a.lasttransitionstyle = r;
                    a.doc.css(l.transitionstyle, r)
                }
                return n
            };
            this.doScrollLeft = function (e, t) {
                ...
                a.timer = setTimeout(function () {
                    ...
                    if (o > 0) {
                        if (!a.scrollrunning && a.onscrollstart) {
                            var u = {type: "scrollstart", current: {x: r, y: n}, request: {x: e, y: t}, end: {x: a.newscrollx, y: a.newscrolly}, speed: o};
                            a.onscrollstart.call(a, u)
                        }
                        if (l.transitionend) {
                            if (!a.scrollendtrapped) {
                                a.scrollendtrapped = true;
                                a.bind(a.doc, l.transitionend, a.onScrollEnd, false)
                            }
                        } else {
                            if (a.scrollendtrapped)
                        ...
                        var f = n;
                        var c = r;
                        a.timerscroll = {bz: new BezierClass(f, a.newscrolly, o, 0, 0, .58, 1), bh: new BezierClass(c, a.newscrollx, o, 0, 0, .58, 1)};
                        if (!a.cursorfreezed)
            ...
            this.cancelScroll = function () {
                ...
                if (!l.transitionend)
                    clearTimeout(l.transitionend);
                a.scrollendtrapped = false;
                a._unbind(a.doc, l.transitionend, a.onScrollEnd);
                a.prepareTransition(0);
                a.setScrollTop(e);
                if (a.railh)
                    a.setScrollLeft(t);
            ...
            this.doScrollPos = function (e, t, n) {
                function c() {
                    ...
                    if (e == 2) {
                        ...
                        if (r != a.newscrollx || t != a.newscrolly)
                            ...
                            if (a.onscrollend) {
                                var i = {type: "scrollend", current: {x: sx, y: sy}, end: {x: a.newscrollx, y: a.newscrolly}};
                ...
                if (a.onscrollstart && !a.scrollrunning) {
                    var d = {type: "scrollstart", current: {x: i, y: r}, request: {x: e, y: t}, end: {x: a.newscrollx, y: a.newscrolly}, speed: f};
        ...
        this.doZoomIn = function (e) {
            ...
            a.win.css({position: l.isios4 ? "absolute" : "fixed", top: 0, left: 0, "z-index": o + 100, margin: "0px"});
    ...
    e.cssHooks["pageYOffset"] = {get: function (e, t, n) {
    ...
    u.cssHooks.pageXOffset = {get: function (e, t, n) {
            var r = u.data(e, "__nicescroll") || false;
    ...
    e.fn.getNiceScroll = function (e) {
        if (typeof e == "undefined") {
            ...
            var t = u.data(this[e], "__nicescroll") || false;
            return t
        }
    };
